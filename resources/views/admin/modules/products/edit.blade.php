                        ...
                        <div class="card-body">
                            <div class="col-xl-12 form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Màu sắc</label>
                                        <input type="text" name="color" id='color' value="{{ $products->color }}"
                                            placeholder="Nhập tên sản phẩm" class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="size" id="size" value="{{ $products->size }}"
                                            placeholder="Nhập size sản phẩm" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="amount" id='amount' value="{{ $products->amount }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Mô tả</label>
                                        <input type="text" name="detail" id='detail' value="{{ $products->detail }}"
                                            placeholder="Nhập mô tả sản phẩm" class="form-control">
